...
{
    public class TwoHandGrabInteractable : UnityEngine.XR.Interaction.Toolkit.Interactables.XRGrabInteractable
    {
        public List<UnityEngine.XR.Interaction.Toolkit.Interactables.XRSimpleInteractable> secondHandGrabPoints = new List<UnityEngine.XR.Interaction.Toolkit.Interactables.XRSimpleInteractable>();
        private UnityEngine.XR.Interaction.Toolkit.Interactors.IXRSelectInteractor firstInteractor, secondInteractor;
